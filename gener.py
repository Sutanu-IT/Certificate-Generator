...
# certificate
template_path =r'C:\Users\Sutanu Chandra\Desktop\Generator\certificate.png'

# Excel file containing names of
# the participants
details_path = r'C:\Users\Sutanu Chandra\Desktop\Generator\test.xlsx'

# Output Paths
output_path = r'C:\Users\Sutanu Chandra\Desktop\Generator\certificate'
...
for i in range(1,11):
	...
	n=str(i)
	certi_path = output_path + '\certi' + n + '.png'
